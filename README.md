...
## 予定
- 仕上げと提出(60分)
  - 公開のページは、Trelloに貼り付けた先のURLを整備すればよい
  - Unityプロジェクト、パッケージ素材、CD素材(あれば)を、共有ドライブ `Y:\2018年\ゲーム学科\学生用` にコピー(木曜日の段階で)
- ポートフォリオやブログページを[Trello](https://trello.com/c/JtlFpGgR/27-%E3%83%9D%E3%83%BC%E3%83%88%E3%83%95%E3%82%A9%E3%83%AA%E3%82%AA%E3%83%BB%E3%83%96%E3%83%AD%E3%82%B0%E3%81%AA%E3%81%A9)のコメントに貼り付ける
  - パッケージやDVDの焼きこみ、印刷
- 作品発表と試遊会
  - 1チーム、試遊合わせて30分まで
  - チームごとに前に出てきて、教員PCで動かしながら、完成品の紹介
  - ゲームの概要、操作方法、ルールを実演しながら紹介
  - DATフェスタからの変更点
  - パッケージデザイン
  - その他なにかあれば
  - 試遊時、感想を[Trelloの感想ボード](https://trello.com/b/BCyk2XsD/卒業制作2018)に記入
    - 匿名がよい場合は、こちらで示す共通アカウントでGoogleアカウントでログインする
    - 感想は、知らない人のゲームを遊んだ前提で客観的に書くことを推奨
...
## 予定発表(木曜日)
- DATフェスタ作品について金曜日までに目途をつけて、1/25には完了させることを目指します
  - Trelloに書き込んで、簡単に内容を伺います。箇条書きでよいです。
    - https://trello.com/b/BCyk2XsD/%E5%8D%92%E6%A5%AD%E5%88%B6%E4%BD%9C2018 を開いて、ログインしたら、今日の日付のボードにコメントとして以下を参考に作業予定を書いてください。1～2行で構いません。
- ポートフォリオや個人作品の進捗
...
- 今年最後の週なので、DATフェスタ作品の公開に向けた進捗報告をお願いします(チーム1人の人がまとめて発表)
